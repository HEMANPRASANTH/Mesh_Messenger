...
fun ScrollingWaveformRecorder(
    ...
    WaveformCanvas(modifier = modifier, samples = samples, fillProgress = 1f, baseColor = Color(0xFF444444), fillColor = Color(0xFF00E5FF))
}
...
fun WaveformPreview(
    ...
    WaveformCanvas(
        ...
        baseColor = Color(0x2200E5FF),
        fillColor = when {
            sendProgress != null -> Color(0xFF1E88E5) // blue while sending
            else -> Color(0xFF00E5FF) // Ice Blue during playback
        },
        onSeek = onSeek
    )
}
